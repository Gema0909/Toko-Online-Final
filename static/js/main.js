// =========================================================================
// 1. FUNGSI GLOBAL (Bisa dipanggil langsung dari atribut HTML seperti onclick)
// =========================================================================
...
// Fungsi memuat produk di halaman katalog pembeli (Shop)
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // C. Simulasi form submit Login (mencegah refresh jika belum ada backend action)
    document.getElementById('loginForm')?.addEventListener('submit', function(e) {
        e.preventDefault(); 
        alert("Tombol login ditekan! (Versi HTML Statis)");
    });

    // D. Simulasi submit form Register
