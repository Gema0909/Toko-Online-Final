...
class Repository:
    def __init__(self):
        # --- PENYESUAIAN DENGAN GAMBAR (Railway Config) ---
        # Ekstrak data koneksi dari MYSQL_PUBLIC_URL di config.py
        ...
        self.db_config = {
            ...
            "port": url.port,
            "database": url.path[1:] # Mengambil nama database dari URL
        }

        # --- PENYESUAIAN BARU DENGAN SERVICE INTERNAL RAILWAY ---
        # (Konfigurasi ini yang akan dipakai oleh Railway saat aplikasi online)
        self.db_config = {
